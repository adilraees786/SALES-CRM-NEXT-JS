...
import SrForm from '../Form/SrForm';
import Button from '@/components/reuseable/Button';
import { createSrSchema } from '@/schema/superadmin';

const CreateSrModal = ({ setModal, obj }) => {
    ...
    const {
        ...
        mode: "onBlur",
        resolver: yupResolver(createSrSchema),
    });
